...
if __name__ == '__main__':
    bname = argv[1]
    os.system("ffmpeg -i {}.mp4 -vn  -c:a mp3 {}.mp3".format(bname, bname))
    api = RequestApi(appid="e6a77238", secret_key="01128930f08e284c9e3eb061d82c3071", upload_file_path="{}.mp3".format(bname))
    api.all_api_request()
    with open(save_path) as f:
        j = json.load(f)
    with open('{}.json'.format(bname),'w+', encoding='utf-8') as f:
        print(j['data'], file=f)
